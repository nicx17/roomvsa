...
export default function ControlPanel() {
  ...
  const setEnvLightIntensity = useRoomStore(
    (state) => state.setEnvLightIntensity,
  );
  const ceilingLightIntensity = useRoomStore(
    (state) => state.ceilingLightIntensity,
  );
  const setCeilingLightIntensity = useRoomStore(
    (state) => state.setCeilingLightIntensity,
  );
  ...
  const handleLoadConfig = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = (event) => {
      try {
        ...
        if (!result.success) {
          alert(
            'Security Alert: The uploaded config file is invalid or corrupted.',
          );
          return;
        }
      ...
      {!isCollapsed && (
        <>
          ...
          >
            ...
            <label className="modern-btn-success" style={{ flex: 1 }}>
          ...
          >
            ...
            {selectedItem && (
              <section className="modern-panel">
                ...
                >
                  ...
                  >
                    <div>
                      <label className="control-label">Wood Grain</label>
                      <select
                  ...
                  {selectedItem.type === 'bed' && (
                    ...
                    >
                      <div>
                        <label className="control-label">Blanket Color</label>
                        <input
                          type="color"
                      ...
                      <div>
                        <label className="control-label">Pillow Color</label>
                        <input
                          type="color"
                  ...
                  >
                    ...
                    >
                      <label className="control-label">
                        Rotation:{' '}
                        {(selectedItem.rotation[1] * (180 / Math.PI)).toFixed(
                          0,
                        )}
                        °
                      </label>
            ...
            <section>
              <h2 className="modern-section-title">Color Palette</h2>
              <div
                style={{
                  display: 'flex',
                  flexDirection: 'column',
              ...
              >
                ...
                >
                  <div style={{ flex: 1 }}>
                    <label className="control-label">Environment Light</label>
                    <input
                      type="range"
                      min="0"
                      max="2"
                ...
                >
                  <div style={{ flex: 1 }}>
                    <label className="control-label">Ceiling Light</label>
                    <input
                      type="range"
                      min="0"
                      max="5"
                ...
                >
                  <div style={{ flex: 1 }}>
                    <label className="control-label">Window Tint Color</label>
                ...
                >
                  <div style={{ flex: 1 }}>
                    <label className="control-label">Window Transparency</label>
                    <input
                      type="range"
                      min="0"
                      max="1"
